    ...
    <script type="text/javascript">
        ...
        function modificar() {
            if (confirm("¿Deseas continuar la modificación?")) {
                var info = obtenerDatos();
                $.ajax({
                    url: "/mantenimientos/apoderado/" + $("#hddCodigo").val(),
                    type: "PUT",
                    data: info,
                    beforeSend: function () {
                        $("#loading").show();
        ...
        function eliminar(id) {
            if (confirm("¿Deseas eliminar el elemento?")) {
                ...
                $.ajax({
                    url: "/mantenimientos/apoderado/" + id,
                    type: "DELETE",
                    data: info,
                    beforeSend: function () {
                        $("#loading").show();
        ...
        function listar() {
            ...
            if(alumno_id != ""){
                $.ajax({
                    url: "/mantenimientos/apoderado/listar",
                    type: "GET",
